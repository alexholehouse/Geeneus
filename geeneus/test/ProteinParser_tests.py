...
class TestProteinParserFunctions(unittest.TestCase):
    ...
    def test_get_number_of_items(self):
        ...
        self.assertEquals(0, testMan.get_size_of_datastore())
        testMan.get_protein_name("P05023")
        self.assertEquals(1, testMan.get_size_of_datastore())
        del testMan
        

    def test_purge(self):
        self.ParserObject.purge_data_store()
        self.assertEquals(0, self.ParserObject.get_size_of_datastore())
